 ...
 * @param {object} tenant - { tenantId, twilio: { accountSid, authToken } }
 * @param {string} day
...
async function runIngestForTenant(db, tenant, day){
  ...
  if (!tenant.twilio || !tenant.twilio.accountSid || !tenant.twilio.authToken) throw new Error('twilio_credentials_missing');
